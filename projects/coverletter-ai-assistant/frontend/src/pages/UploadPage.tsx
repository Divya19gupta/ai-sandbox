...
const UploadPage = () => {
  ...
  return (
    <Box sx={{ bgcolor: '#08080F', minHeight: '100vh' }}>
      ...
      {/* HERO + FORM = single column on mobile, two columns on desktop */}
      <Box sx={{
        display: 'grid',
        ...
        <Box>
          ...
          <Box sx={{ bgcolor: '#13111F', border: '1px solid #2D2A3E', borderRadius: 4, overflow: 'hidden' }}>
            ...
            {/* Steps: stack on mobile, side by side on sm+ */}
            <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: '1fr 1fr' } }}>
              ...
              <Box sx={{ p: { xs: '20px', md: '24px' }, borderRight: { xs: 'none', sm: '1px solid #1E1B2E' }, borderBottom: { xs: '1px solid #1E1B2E', sm: 'none' } }}>
                ...
                <Box
                  ...
                  sx={{ border: '2px dashed #2D2A3E', borderRadius: 2, p: { xs: 3, md: 4 }, textAlign: 'center', cursor: 'pointer', transition: 'all 0.2s', '&:hover': { borderColor: '#7C3AED', bgcolor: '#1A1728' } }}
                >
              ...
              <Box sx={{ p: { xs: '20px', md: '24px' } }}>
                ...
                <textarea
                  ...
                  style={{ width: '100%', height: 150, background: '#0A0A0F', border: '1px solid #2D2A3E', borderRadius: 10, padding: '12px 14px', color: '#F0EEF9', fontSize: 14, resize: 'none', outline: 'none', fontFamily: 'inherit', lineHeight: 1.6 }}
                />
              </Box>
            </Box>
            ...
            <Box sx={{ p: { xs: '16px 20px', md: '18px 28px' }, borderTop: '1px solid #1E1B2E', display: 'flex', alignItems: 'center', justifyContent: 'space-between', bgcolor: '#0D0B18', flexWrap: 'wrap', gap: 2 }}>
              ...
              <Button
                ...
                disabled={loading}
                sx={{ background: 'linear-gradient(135deg,#7C3AED,#6D28D9)', color: 'white', fontWeight: 700, fontSize: { xs: 13, md: 15 }, px: { xs: 3, md: 4 }, py: { xs: 1.2, md: 1.5 }, borderRadius: 2, textTransform: 'none', boxShadow: '0 4px 14px rgba(124,58,237,0.3)', '&:hover': { transform: 'translateY(-1px)', boxShadow: '0 6px 20px rgba(124,58,237,0.4)' } }}
              >
        ...
        <Box sx={{ display: { xs: 'none', lg: 'flex' }, alignItems: 'center', justifyContent: 'center' }}>
          <Box sx={{ position: 'relative', width: '100%', maxWidth: 420, height: 480 }}>
            ...
            {[
              ...
              { text: 'No re-writes..', top: 160, left: -20, color: '#eeabf8', delay: '0.5s' },
